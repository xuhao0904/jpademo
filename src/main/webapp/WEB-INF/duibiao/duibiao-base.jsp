...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
	...
	<script type="text/javascript">
		...
		function getInfo(pagenum){
			$.ajax({
				type: "get",
				url: "${pageContext.request.contextPath}/duibiao/page",
				data:{"pagenum":pagenum},
				dataType:"json",
				success: function(result){
					//清除原有的表格中的数据
					$("#duibiaoTable tr:gt(1):not(tr[id=operate])").remove();
					$.each(result.list,function(index,element){
						var tr="<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
								...
								"\t<td>"+element.daid+"</td>\n" +
								"\t<td ><a href=''><u>"+element.dacname+"</u></a></td>\n" +
								"\t<td>"+element.daturnover+"亿</td>\n" +
								"\t<td>"+element.dasuperiority+"</td>\n" +
								"\t<td>"+element.empcount+"</td>\n" +
								"\t<td>"+getDate(element.buildtime)+"</td>\n" +
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px" id="duibiaoTable">
<tr bgcolor="#E7E7E7">
...
<td height="28" colspan="12">
	...
	<a href="${pageContext.request.contextPath}/duibiao/duibiao-add" class="coolbg">&nbsp;添加采集信息&nbsp;</a>
</td>
</tr>
