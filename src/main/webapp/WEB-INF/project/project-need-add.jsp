...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><select  id="proname" name="proname"></select></td>
</tr>
<tr >
...
<script >
	$(function(){
		$.getJSON("${pageContext.request.contextPath}/analysis/findProjectNoAna",function (data) {
					$.each(data,function (index,element) {
						var op="<option value="+element.pname+">"+element.pname+"</option>"
							$("#proname").append(op)
					})
		})
	})
