...
<script type="text/javascript">
	function commit(){
		$.post("${pageContext.request.contextPath}/baoxiao/myupdate",$("#baoxiaoForm").serialize(),function (data) {
			if(data.flag){
				alert(data.messages);
				window.location.href="${pageContext.request.contextPath}/baoxiao/mybaoxiao-base";
			}else{
				alert(data.messages);
			}
		},"json");
...
<form id="baoxiaoForm" action="${pageContext.request.contextPath}/office/baoxiao/updateBaoxiaoBohui" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input size="52" name="bxtime" id="bxtime" value='<fmt:formatDate value="${baoxiao.bxtime}" pattern="yyyy/MM/dd"/>'/>
	</td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" >备注：</td>
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=10 cols=130  id="bxremark" name="bxremark">
			${baoxiao.bxremark}
		</textarea>
	</td>
</tr>
